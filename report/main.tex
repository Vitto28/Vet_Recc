...
Place the dataset under a local directory of your choice. The notebook resolves the data path dynamically, following the order described in \texttt{README.md}. A local \texttt{paths.local.json} file can be used to point the notebook to the dataset without hard-coding personal paths.
